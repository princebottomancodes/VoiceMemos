...
class SwipeActionCell extends StatefulWidget {
  ...
  const SwipeActionCell(
      ...
      this.editModeOffset = 36,
      this.fullSwipeFactor = 0.75,
      this.deleteAnimationDuration = 000,
      this.normalAnimationDuration = 000,
...
class SwipeActionCellState extends State<SwipeActionCell>
        ...
        child: RawGestureDetector(
          ...
          gestures: {
            TapGestureRecognizer:
              ...
              instance.onTap = editing && !editController.isAnimating ||
                      currentOffset.dx != 0.0
                  ? () {
  ...
  Widget _buildSelectedButton(bool selected) {
    return selected ? widget.selectedIndicator : widget.unselectedIndicator;
  }
